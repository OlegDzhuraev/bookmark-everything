...
## How to install
Using Unity Package Manager, choose git install and paste this:

```
https://github.com/OlegDzhuraev/bookmark-everything.git?path=BookmarkEverything/Assets/BookmarkEverything
```
